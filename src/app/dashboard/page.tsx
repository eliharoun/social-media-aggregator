    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">AI-powered summaries from your favorite TikTok creators</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Start by adding your favorite TikTok creators to see their latest content summaries here.
          </p>
          <a
            href="/creators"
